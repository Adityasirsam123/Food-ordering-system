...
"""
#<!--<form id="payment-form" action="{% url 'payment_callback' %}" method="POST" <form id="payment-form" action="{% url 'payment_callback' %}" method="POST"></form>-->
...
urlpatterns = [
   ...
   path('payment/', views.payment_view, name='payment'),
    #path('payment/callback/', views.payment_callback, name='payment_callback'),
     ...
     path('payment/failure/', views.payment_failure, name='payment_fail')
]
if settings.DEBUG:
